    ...
    $(function() {
        ...
        $("#btn-load").click(function() {
            $.ajax({
                ...
                url: "<?= $fullUrl ?>/get_ajax_customer_by_source",
                dataType: "json",
