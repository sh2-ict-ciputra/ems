...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url()?>/transaksi_lain/p_monitoring_liaison_officer/aksi_pembayaran2?id=<?=$this->input->get('id');?>">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						...
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="total_survei2" value="<?= number_format($dataSelect->sisa_deposit)?>" readonly="" id="total_bayar" value="0" class="form-control currency">
							</div>
						</div>
							...
							<div class="col-md-5 col-sm-12 col-xs-2">
								<div class="checkbox">
									<label>
										...
										<input type="checkbox" name="status_bayar_survei2" class="js-switch" value="1" />
