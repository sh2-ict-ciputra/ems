	...
	<div class="col-md-6">
		...
		<div class="form-group pay">
			...
			<div class="form-group pay">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text"  name="total_akhir" id="total_akhir"   value="<?=$data_select->total_tagihan; ?>"
			...
			<div class="form-group pay">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" required="" placeholder="Masukkan Total tagihan biaya tambahan" id="total_bayar"
					 name="total_bayar" value="<?=$data_select->total_tagihan; ?>" class="form-control pay currency disabled-form" >
				</div>
			</div>
