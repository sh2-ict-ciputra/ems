				...
				<div class="col-md-12">
					...
					<div id="lihat_paket">
						<div class="col-md-9 col-sm-9 col-xs-12">
                         ...
                         hari kalender ( dari tanggal pemasangan mulai)
                         </div>
	...
	$("#jenis_paket").change(function () {
		...
		if (data == "") {
			...
			$("#harga_paket").val(currency(harga_paket));
             ...
             if ((harga_pasang == null) || (harga_pasang == '') || (harga_pasang == 0))
             {
...

             {
                ...
                $("#harga_pasang").val(currency(harga_pasang));
              	...
              	alert(harga_registrasi);


              if ((harga_registrasi == null )|| (harga_registrasi == ' ')|| (harga_registrasi == 0))
             {
