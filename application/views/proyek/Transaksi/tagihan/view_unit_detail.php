...
<div style="float:right">
	<h2>
		<button class="btn btn-warning" onClick="window.location.href='<?= site_url() ?>/Transaksi/P_tagihan/unit?periode=<?=$this->input->get('periode')?>'">
		...
		$("#btn-load-blok").click(function() {
			...
			if ($("#blok").val() != null) {
				$.ajax({
					...
					url: "<?= site_url() ?>/Transaksi/P_tagihan/ajax_get_unit_detail",
					dataType: "json",
