	...
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/P_transaksi_meter_air/save">
		<div class="col-md-6 col-xs-12">
					...
					<select id="unit" name="unit" class="form-control select2">
						...
						<?php
							foreach ($data as $v) {
                                ...
                                echo($dataSelect->unit==$v->id?' selected':'');
                                echo(">$v->kawasan  -  $v->blok  -  $v->unit</option>");
							}
						?>
					</select>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class='input-group date '>
						<input type="text" class="form-control datetimepicker_month" name="bulan" placeholder="Masukkan Tanggal Aktif" value="<?=$dataSelect->bulan?>" >
				...
				<div class="col-md-5 col-sm-5 col-xs-12">
					<div class='input-group date '>
						<input type="text" class="form-control datetimepicker_year" name="tahun" placeholder="Masukkan Tanggal Aktif" value="<?=$dataSelect->tahun?>">
						<span class="input-group-addon">
							<span class="glyphicon glyphicon-calendar"></span>
						</span>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<textarea name="keterangan" class="form-control" rows="3" placeholder='-- Masukkan Keterangan --'><?=$dataSelect->keterangan?></textarea>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-xs-12">
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input id="customer" type="text" class="form-control" placeholder="-- Auto Generated --" value="<?=$dataSelect->customer?>" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">ID Barcode</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input id="barcode" type="text" class="form-control" placeholder="-- Auto Generated --" value="<?=$dataSelect->no_seri_meter?>" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Meter Awal / m3</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input id="meter_awal" type="text" class="form-control currency" placeholder="-- Auto Generated --" value="<?=$dataSelect->meter_awal?>" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Meter Akhir / m3</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input id="meter_akhir" type="text" class="form-control currency" placeholder="-- Pilih Unit Dahulu --" name="meter" value="<?=$dataSelect->meter_akhir?>" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Pemakaian / m3</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input id="pemakaian" type="text" class="form-control" placeholder="-- Auto Generated --" value="<?=$dataSelect->pemakaian?>" disabled>
				</div>
			</div>
