        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-delete" action="<?=site_url("Transaksi/P_ubah_tagihan/update/$unit_id")?>" method="post">
                        <input type="hidden" name="method" value="put">
                        <input type="hidden" name="tagihan_id" id="tagihan_id">
                        <input type="hidden" name="service_id" id="service_id">
                        <input type="hidden" name="periode" id="periode">
                        <div class="form-group">
                            <label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12">Total Nilai Baru</label>
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" name="nilai" class="col-md-12" required>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-submit-2" type="button" class="btn btn-primary">Update</button>
                </div>
            </div>
        </div>
    </div>
