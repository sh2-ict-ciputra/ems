...
<div>
    ...
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:90px;text-align:center" border="1">
        <thead>
            <tr>
                <th><p style="text-align:center;font-size:14px;height:10px;width:656px">BUKTI PEMBAYARAN PEMAKAIAN AIR (WTP)</th>
            </tr>
        </thead>
    </table>
    ...
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:90px" border="1">
        <tbody>
            <tr>
                <th><p style="text-align:center;font-size:14px;height:10px;width:656px">RINCIAN PENGGUNAAN DAN BIAYA AIR (WTP)</th>
            </tr>
            <tr>
                <td>
                    <p style="padding-top:5px;margin-left:5px">METER AWAL <span class="tab">: <?=$meter->awal?> m<span class="superscript">3</span></span></p>
                    <p style="padding-top:-10px;margin-left:5px">METER AKHIR <span class="tab">: <?=$meter->akhir?> m<span class="superscript">3</span></span></p>
                    <p style="padding-top:-10px;margin-left:5px">METER PAKAI <span class="tab">: <?=$meter->pakai?> m<span class="superscript">3</span></span></p>
                </td>
            </tr>
