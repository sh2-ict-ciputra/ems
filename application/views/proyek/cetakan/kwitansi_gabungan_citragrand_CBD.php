...
<div>
    ...
    <table id="items" style="padding-left:550px;padding-top:40px">
        <tr>
            <td style="text-align:right;padding-top:-15px"><?=$periode_first." - ".$periode_last?></td>
    ...
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:45px;text-align:center;padding-top:95px">
        <!-- <thead>
            <tr>
        ...
        <tr>
            ...
            <td style="text-align:center;;padding-left:50px"><?=$pembayaran_air->tagihan?></td>
            <?php }else{?>
        ...
        <tr>
            ...
            <td style="padding-top:15px;padding-left:60px"><?=$pembayaran_lingkungan->denda?></td>
            <td style="padding-top:15px"><?=$pembayaran_lingkungan->total?></td>
        </tr>
        <tr>
            <td colspan="4" style="padding-top:30px;padding-left:15px">PPN IPL <?= $pembayaran_lingkungan->ppn?>% = Rp.<?=$pembayaran_lingkungan->ppn_rupiah?></td>
