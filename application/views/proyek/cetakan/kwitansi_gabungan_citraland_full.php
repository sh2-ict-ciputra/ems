...
<div>
    ...
    <div id="items" style="margin-top:130px;margin-left:60px">
        <div style="float:left">NO. TRANS : 000001</div>
        <div style="float:right">PERIODE : <?=$periode_first?> S/D <?=$periode_last?></div>
    </div>
    <div id="items" style="margin-top:130px;">
        <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:40px;text-align:center" border="1">
            <thead>
                <tr>
                    <th><p style="text-align:center;height:8px;width:656px">KWITANSI AIR BERSIH & IURAN PENGELOLAAN LINGKUNGAN (I.P.L)</p></th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:40px;text-align:center;padding-top:10px" border="1">
        <thead>
            <tr>
    ...
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:40px;text-align:center;padding-top:2px" border="1">
        <thead>
            <tr>
    ...
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:40px;text-align:center;padding-top:2px" border="1">
        <thead>
            <tr>
                <th><p style="text-align:center;height:10px;width:656px">PERINCIAN IURAN PENGELOLAAN LINGKUNGAN (I.P.L)</th>
            </tr>
        </thead>
    </table>
    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row" style="padding-left:40px;text-align:center;padding-top:2px" border="1">
        ...
        <tbody>
            <tr>
                <td><?= $pembayaran_lingkungan->tagihan_tanpa_ppn?></td>
                <td><?= $pembayaran_lingkungan->ppn_rupiah?></td>
    ...
    <table style="padding-left:21px;padding-top:5px">
        <td id="box1">
    ...
    <div class="col-md-12 col-sm-12 col-lg-12 row" style="padding-top:5px">
        <div class="col-md-5 col-sm-5 col-lg-5" style="margin-left:20px" id="box3">
            <table>
                <tr>
                    <td><p style="margin-top:5px">Outstanding</p></td>
                    <td><p style="margin-top:5px">&nbsp;:&nbsp;</p></td>
                    <td><p style="margin-top:5px">0</p></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><p style="margin-top:3px">No. I.P.L</p></td>
                    <td><p style="margin-top:3px">&nbsp;:&nbsp;</p></td>
                    <td><p style="margin-top:3px">0</p></td>
                </tr>
            </table>
        </div>
        <div class="col-md-5 col-sm-5 col-lg-5" style="padding-left:580px">
            <p class="lh-5 f-15">BOGOR, <?=date("d-m-Y");?></p>
            <p class="lh-5 f-15" style="padding-top:70px;"><?=$user?></p>
        </div>
    </div>
</div>
</body>
