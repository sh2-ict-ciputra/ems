...
class P_permission_dokumen extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('proyek/setting/akun/Permission_Dokumen/view2', ['data' => $data]);
    ...
    public function edit()
    {
        ...
        $data_range = $this->m_dokumen->get_range($this->input->get("id"),$this->m_core->project()->id,1);
        $data_range_mengetahui = $this->m_dokumen->get_range($this->input->get("id"),$this->m_core->project()->id,0);
        if(!$data_range){
        ...
        $this->load->view('proyek/setting/akun/Permission_Dokumen/edit2',
            [
                "data"=>$data,
    ...
    public function ajax_save(){
        echo(json_encode($this->m_dokumen->save($this->input->get(),$this->m_core->project()->id)));
    }
}
