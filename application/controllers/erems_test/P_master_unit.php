    ...
    public function ajax_get_view(){
        ...
        foreach ($table["data"] as $k => $v) {
			...
			$table["data"][$k][count($v)-1] = 
				"<a href='".site_url()."/erems_test/P_master_unit/edit?id=".end($v)."' class='btn btn-primary col-md-10'>
