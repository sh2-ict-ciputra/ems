...
class P_history_pembayaranv2 extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('proyek/transaksi/history_pembayaran_harian/viewv2',['kawasan'=>$kawasan,'cara_bayar'=>$cara_bayar,'service_jenis'=>$service_jenis]);
		$this->load->view('core/body_footer');
		$this->load->view('core/footer');
	}
	...
	public function pdf()
	{
		...
		// 	print_r($data);
		// echo("</pre>");
		$pdf = $this->pdf->load_view('proyek/transaksi/history_pembayaran_harian/viewv3',['data'=>$data]);
