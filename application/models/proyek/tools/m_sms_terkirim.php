...
class m_sms_terkirim extends CI_Model
{
    public function get()
    {
        $query = $this->db->query('
     ...
     public function getAll()
    {
        ...
        $query = $this->db->query("
            SELECT project.name as project_name,
                   ...
                   t_sms_terkirim.tanggal_dikirim as tanggal_dikirim,
                   t_sms_terkirim.pesan as pesan,
                   t_sms_terkirim.id as id,
                   t_sms_terkirim.active as active



             FROM t_sms_terkirim
            left join unit on unit.id = t_sms_terkirim.unit_id
            ...
            where t_sms_terkirim.project_id = $project->id
