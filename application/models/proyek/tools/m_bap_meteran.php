...
class m_bap_meteran extends CI_Model
{
        ...
        public function getAll()
    {
        ...
        $query = $this->db->query("
            SELECT 
                t_bap_meteran.id,
                t_bap_meteran.active,
                project.name as project_name,
                kawasan.name as kawasan_name,
                blok.name as blok_name,
                unit.no_unit as unit,
                customer.name as customer_name,
                t_bap_meteran.no_berita_acara as no_berita_acara,
                t_bap_meteran.jenis_transaksi as jenis_transaksi,
                t_bap_meteran.jenis_transaksi as jenis_meter,
                t_bap_meteran.tanggal as tanggal,
                t_bap_meteran.status_approval as status_approval  

             FROM t_bap_meteran
            left join unit on unit.id = t_bap_meteran.unit_id
            left join blok on unit.blok_id = blok.id
            left join kawasan on blok.kawasan_id = kawasan.id
