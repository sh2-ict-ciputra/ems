...
class m_email_terkirim extends CI_Model
{
    public function get()
    {
        $query = $this->db->query('
            SELECT * FROM t_template_email
        ');
     ...
     public function getAll()
    {
        ...
        $query = $this->db->query("
            SELECT project.name as project_name,
                   ...
                   t_email_terkirim.tanggal_dikirim as tanggal_dikirim,
                   t_email_terkirim.pesan as pesan,
                   t_email_terkirim.id as id,
                   t_email_terkirim.active as active



             FROM t_email_terkirim
            left join unit on unit.id = t_email_terkirim.unit_id
            ...
            where t_email_terkirim.project_id = $project->id
