...
class m_group_sms_email extends CI_Model
{
    public function get()
    {
        $query = $this->db->query('
    ...
    public function save($dataTmp)
    {
        ...
        $this->db->where('nama_grup', $datTmp['nama_grup']);
        $this->db->from('t_group_sms_email');
