...
class m_st_liaison_officer extends CI_Model
{
    ...
    public function save($dataTmp)
    {
        ...
        [
            ...
            'status_dokumen' => 5,
            'status_deposit' => $dataTmp['action_st']
        ];
    ...
    public function getSelect($id)
    {
        ...
        SELECT     
            ...
            t_loi_registrasi.status_deposit as status_deposit,
        ...
        project.name,
            ...
            t_loi_deposit.deposit_pemakaian2,
            t_loi_deposit.sisa_deposit,
            kategori_loi.nama,
            jenis_loi.nama,
            peruntukan_loi.nama,
            paket_loi.nama,
            t_loi_registrasi.status_deposit
        ");
        $row = $query->row();
        return $row;
    }
