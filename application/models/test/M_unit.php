...
class m_unit extends CI_Model
{
    ...
    public function getKawasan()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM kawasan where active =1 order by id asc
        ");
    ...
    public function getUnit()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM unit where active =1  order by id asc
        ");
    ...
    public function getCustomer()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM customer where active =1 order by id asc
        ");
    ...
    public function getGolongan()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM jenis_golongan where active =1 order by id asc
        ");
    ...
    public function getPemeliharaanMeterAir()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM pemeliharaan_meter_air where active =1 order by id asc
        ");
    ...
    public function getPemeliharaanMeterListrik()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM pemeliharaan_meter_listrik where active =1 order by id asc
        ");
