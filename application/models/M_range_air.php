	...
	public function get_log($id)
    {
        ...
        $query = $this->db->query("
			...
			SELECT  
                    ...
                    case when range_air.active = 0	 then 'Tidak Aktif' else 'Aktif' end as aktif, 
                    case when range_air.[delete] = 0 then 'Tidak di Hapus' else 'Terhapus' end as [delete],
            ...
            WHERE				range_air.id             = $id
            AND					range_air.project_id     = $project->id
            ORDER BY			range_air_detail.id		  ASC
